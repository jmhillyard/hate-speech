...
with open('/Users/janehillyard/Documents/capstone/hate-speech/data/vectorizer.pkl') as f:
    vectorizer = pickle.load(f)
with open('/Users/janehillyard/Documents/capstone/hate-speech/data/mymodel.pkl') as f:
        model = pickle.load(f)
